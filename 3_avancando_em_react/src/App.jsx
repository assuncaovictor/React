...
import Banner from "./components/content/Leason/Banner";
import List from "./components/content/Leason/List";
import Profile from "./components/content/Leason/Profile";
import Quote from "./components/content/Leason/Quote";
import Theme from "./components/content/Leason/Theme";
    ...
    return (
        <>
            ...
            <div style={{ padding: "0 2rem" }}>
                ...
                {/* Função como prop */}
                <Theme theme={theme} handleClick={changeTheme} />
            </div>
        </>
    );
};
